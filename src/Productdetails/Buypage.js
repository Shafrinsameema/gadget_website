  ...
  return (
    <div className="mobile-buying-page">
      ...
      <div class="additional-details">
        <p> <i class="fa-solid fa-repeat"></i>7 days Service Centre Replacement</p>
        <p><i class="fa-solid fa-truck"></i> Free Delivery</p>
        <p><i class="fa-regular fa-calendar-check"></i> 1 Year Warranty</p>
        <p><i class="fa-solid fa-sack-dollar"></i>Cash on Delivery</p>
      </div>
